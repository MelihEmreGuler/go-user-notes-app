        ...
        <Layout>
            <main>
                <header className="flex justify-between pb-4 pt-8 border-b">
                    <Link to="/" className="bg-gray-100 hover:bg-gray-200 transition-colors duration-300 rounded-full p-2 flex items-center justify-center">
                        <RiArrowLeftLine size={28}/>
                    </Link>
                    <span className="font-semibold text-2xl text-emerald-500">Create Your New Note!</span>
                ...
                <form action="" className="h-screen flex flex-col justify-start p-10 items-center gap-10">
                    ...
                    <label htmlFor="content" className="w-full flex flex-col gap-2">
                        ...
                        <textarea required id="content" rows={20} onChange={({ target }) => setContent(target.value)} className="appearance-none p-3 border focus:shadow-md w-full rounded-md"/>
                    </label>
